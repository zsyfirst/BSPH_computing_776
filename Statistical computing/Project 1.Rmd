...
# Identify duplicate rows based on the continet column
...
longdata %>%
  ...
  geom_point(color = "steelblue",  size = 2, alpha = 2 ) +
  geom_smooth(  linewidth = 1, method = "lm" , color = "darkblue" ) +
  facet_wrap(vars(feature)) +
  labs(
    title = "Mean scores of chocolate's ingredients and the most memorable characteristics over time",
    subtitle = "Trends: the mean scores of beans, sugar, and salt didn't change over time, ingredients including cocoa butter, vanilla, and letchin decreased over time. \nThe trend of most memorable characteristics didn't change over time",
    caption = "Siyu Zou",
    x = "Review year",
    y = "Mean score"
  ) +
...
* The plot.title element controls the appearance of the plot title, set the font size to 18, with green color and bold face, "hjust = 1" means put the title in the right. 
...
* Put the legend on the left top and inside the plot, without adjusting the room: legend.position = c(0, 1),
...
review_number_50 %>% 
  ggplot(aes( review_date , percent)) + 
  geom_smooth() + 
  geom_point( alpha = 2, color = "lightblue") + 
  facet_wrap( ~ country_of_bean_origin ) + 
  labs(
    title = "Trends of chocolate's percent by review time, stratified by country",
    subtitle = "Trends: the percentage of chocolate didn't change much over time",
