...
```{r}
distribution_city_year <- function(city_name, year) {
    if (!any(df$city_name == city_name) || !any(df$year == year)) {
    ...
    labs(
        title = paste("Distribution of rainfall for",city_name, "in", year),
